package io.manbang.easyByteCoder.plugin.simplecount.mock.runtime;


import io.manbang.easyByteCoder.plugin.simplecount.mock.uitl.FileUtil;
...
public class BeanTimeCountHandle {
    ...
    public static void timeMapToFile() {
        ...
        FileUtil.fWriter("./", "creatBeanTime", beanCreateTime);
    }
