 ...
 */
public class BinlogClientMockModifier extends ClassModifier {

    private Map<String, MethodModifyCode> methodModifiers;

    public BinlogClientMockModifier(){
    ...
    public String getToModifyClassName() {
        return "com/mb/binlog/center/wharf/agent/job/JobPool";
    }
    ...
    private class BinlogInitMethodModifier extends MethodModifyCode {
        ...
        public String getCodeToSetBody(CtMethod method) {
            return "{ EasyByteCoderResourceObjectPool.getEasyByteCoderLogger().info(\"[BinlogInitMethodModifier]Preventing Binlog job pool init.\");"
                    + "return; }";
        }
    }
}
